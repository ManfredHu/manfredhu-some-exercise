...
// 使用 diff 命令生成增量包
const diffProcess = spawnSync('diff', ['-u', oldVersionFile, newVersionFile]);
const diffOutput = diffProcess.stdout.toString();

// 将增量包写入文件
fs.writeFileSync(diffPatchFile, diffOutput);

console.log('增量包生成成功:', diffPatchFile);
