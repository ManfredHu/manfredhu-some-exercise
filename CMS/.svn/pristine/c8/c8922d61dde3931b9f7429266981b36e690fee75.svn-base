...
<h1>&lt;Code&Share&gt;<br/>代码托管系统</h1>
	<form style="top:15%" class="login" id="registerForm"  action="register.action" method="post"  >
		<h2>
			用户注册
		</h2>
		<div class="user">
			<label class="label2">用户名</label>
			<input class="text" name="user.userName" type="text" />
		</div>
		<div class="normal">
			<label class="label2">昵称</label>
			<input class="text" name="user.name" type="text"  />
		</div>
		<div class="normal">
		...
		<div class="normal">
			<label class="label2">确认密码</label>
			<input class="text" name="comfirmPassword" type="password"  />
		</div>
		<div class="password">
			<label class="label2">邮箱</label>
			<input class="text" name="user.email" type="text"  />
		</div>
