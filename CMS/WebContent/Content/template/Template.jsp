...
<link href="/CMS/Content/CSS/normalize.css" rel="stylesheet"
	type="text/css" />
<link href="/CMS/Content/CSS/template.css" rel="stylesheet"
	type="text/css" />
...
<body>
	<header>
		<div class="center">
			...
			<nav>
				<a href="/CMS/code/codeList.action">我的代码</a> <a
					href="/CMS/code/shareList.action">代码共享</a>
			</nav>
			<div class="aList">
				<h2>欢迎您，${sessionScope.user.name }</h2>
				<a class="modify" href="/CMS/user/UserInfo">修改个人信息</a> <a
					class="password" href="/CMS/user/UpdatePassword">修改密码</a>
