...
<title>管理用户</title>
<link href="/CMS/Content/CSS/userManage.css" rel="stylesheet"
	type="text/css" />
</head>
			...
			<tbody>
				<s:iterator id="UserManage" value="userList">
					<tr>
						...
						<td><a class="fmodify"
							href="updateUser?userID=${UserManage.userID }">修改</a> <a
							class="fdelete" href="deleteUser?userID=${UserManage.userID }">删除</a>
